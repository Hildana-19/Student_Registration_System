...
public class BachelorForm extends JFrame {
    ...
    public BachelorForm() {
        setTitle("Bachelor Student Registration");
        setSize(595, 842);
        ...
        String[] departments = {"Software Engineering", "Information Technology Systems"};
    ...
    BachelorStudent student = new BachelorStudent(
        name, "", "", dob, "Bachelor", year, department
    );

    DBConnection db = new DBConnection();
    db.insertStudent(student);

    JOptionPane.showMessageDialog(this, "Student saved to DB!");
    dispose(); 
});
